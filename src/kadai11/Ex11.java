...
public class Ex11 {
  ...
  private void initialize() {
    ...
    btnNewButton1.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        AbstractImageFilter BinaryImageFilter = new BinaryImageFilter();
        imgGray.applyFilter(BinaryImageFilter);
        imagePanel.setImage(imgGray);
      }
    });
    ...
    btnNewButton2.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        AbstractImageFilter NegativeImageFilter = new NegativeImageFilter();
        imgGray.applyFilter(NegativeImageFilter);
        imagePanel.setImage(imgGray);
      }
    });
  }
